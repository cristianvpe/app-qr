...
const PoliticaDeCookies = () => {
  return (
    <div className="politica-cookies">
      ...
      <p>
        Si tiene dudas sobre esta política de cookies, puede contactar con Patrimonio Nacional en <a href="mailto:info@patrimonionacional.es">info@patrimonionacional.es</a>.
      </p>
    </div>
  );
};
